      ...
      <section className="mb-12">
        <div className="bg-gray-100 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            At Fundastic Platform, our mission is to connect passionate
            ...
            attract support from donars who share their vision.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        <div className="bg-gray-100 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            we strive to empower creators and donars alike, fostering a
      ...
      <section className="mb-12">
        <div className="bg-gray-100 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            create and manage their campaigns, while donars can discover a
      ...
      <section className="mb-12">
        <div className="bg-gray-100 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed space-y-2">
            ...
            <li>
              Empowerment: We strive to empower both fundraisers and donars
